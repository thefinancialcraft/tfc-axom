...
export default function Footer() {
  return (
    <div style={{ marginTop: '140px', paddingBottom: '30px', textAlign: 'center', paddingLeft: '24px', paddingRight: '24px' }}>
      ...
      <div style={{ color: 'var(--text-color)', fontSize: '22px', fontWeight: '600', marginBottom: '30px', background: 'linear-gradient(to right, #fff, #888)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
