      ...
      <div className={styles.container}>
        ...
        <div className={styles.headerSection} style={{ padding: '90px 0 20px 0' }}>
          <div className={styles.titleGroup}>
            <p style={{ fontSize: '18px', fontWeight: '300', margin: '0 0 8px 0', color: 'rgba(255, 255, 255, 0.6)', fontFamily: 'var(--font-lufga), sans-serif' }}>
              Users
            </p>
            <h1 style={{ fontSize: '36px', fontWeight: '500', margin: '0', color: 'var(--color-white)', letterSpacing: '-1px', lineHeight: '1.1', fontFamily: 'var(--font-lufga), sans-serif' }}>
              Live Users
            </h1>
            <p style={{ color: 'rgba(255, 255, 255, 0.5)', fontSize: '14px', marginTop: '10px', fontFamily: 'var(--font-lufga), sans-serif' }}>
              Create, update, and manage employee profiles and application access.
            </p>
          </div>
